...
DEFAULT_OUTPUT = "results/cascade/student_base_responses_spider_train.json"
SAVE_EVERY = 20
...
def main():
    ...
    if args.output is None:
        args.output = f"results/cascade/student_base_responses_{dataset_label}_{split_label}{variant_tag}.json"
